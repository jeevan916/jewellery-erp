    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("reversal_of", models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name="reversal", to="accounting.voucher")),
                ("voucher_type", models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name="vouchers", to="accounting.vouchertype")),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("code", models.CharField(max_length=40)),
                ("account_type", models.CharField(choices=[("LEDGER", "Ledger"), ("CONTROL", "Control")], default="LEDGER", max_length=12)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("financial_period", models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name="journal_entries", to="accounting.financialperiod")),
                ("voucher", models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name="journal_entry", to="accounting.voucher")),
            ],
        ...
        migrations.AddConstraint(model_name="journalline", constraint=models.UniqueConstraint(fields=("journal_entry", "line_no"), name="uq_journal_line_no")),
        migrations.AddConstraint(model_name="journalline", constraint=models.CheckConstraint(condition=Q(debit__gte=0), name="journal_line_debit_nonnegative")),
        migrations.AddConstraint(model_name="journalline", constraint=models.CheckConstraint(condition=Q(credit__gte=0), name="journal_line_credit_nonnegative")),
        migrations.AddConstraint(model_name="journalline", constraint=models.CheckConstraint(condition=~(Q(debit__gt=0) & Q(credit__gt=0)), name="journal_line_not_both")),
        migrations.AddConstraint(model_name="journalline", constraint=models.CheckConstraint(condition=Q(debit__gt=0) | Q(credit__gt=0), name="journal_line_nonzero")),
    ]
